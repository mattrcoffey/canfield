    ...
    public function getValuesHtml() {
        ...
        if ($_option->getType()==Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN || $_option->getType()==Mage_Catalog_Model_Product_Option::OPTION_TYPE_MULTIPLE) {            
            ...
            foreach ($_option->getValues() as $_value) {                
                ...
                if ($enabledInventory && $hideOutOfStockOptions && $customoptionsQty===0) continue;                
                ...
                if ($enabledInventory) {
                    ...
                    if (substr($customoptionsQty, 0, 1)=='x') {
                        ...
                        $setProdutQtyJs .= 'optionsSetQtyProductData['.$_option->getId().']['.$_value->getOptionTypeId().']='.intval(substr($customoptionsQty, 1)).';';
                    }
                }
