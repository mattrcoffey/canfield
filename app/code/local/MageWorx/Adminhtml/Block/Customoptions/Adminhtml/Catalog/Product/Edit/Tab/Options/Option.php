            ...
            foreach ($optionsArr as $option) {
                ...
                if ($option->getGroupByType() == Mage_Catalog_Model_Product_Option::OPTION_GROUP_SELECT) {
                    ...
                    foreach ($option->getValues() as $_value) {
                        ...
                        list($price, $priceType) = $helper->getOptionPriceAndPriceType($_value->getPrice(), $_value->getPriceType(), $_value->getSku(), $this->getProduct()->getStore());
                        ...
                        $value['optionValues'][$i] = array(
                            ...
                            'image_button_label' => ($_value->getImagePath()?$helper->__('Change Image'):$helper->__('Add Image')),
                    ...
                    list($price, $priceType) = $helper->getOptionPriceAndPriceType($option->getPrice(), $option->getPriceType(), $option->getSku(), $this->getProduct()->getStore());
